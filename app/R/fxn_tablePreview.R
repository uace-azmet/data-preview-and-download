...
fxn_tablePreview <- function(inData, timeStep) {
  ...
  if (timeStep == "Daily") { # Daily data formatting
    tablePreview <- tablePreview |>
      DT::formatRound(
        columns = c(
          "chill_hours_0C", "chill_hours_20C", "chill_hours_32F", "chill_hours_45F", "chill_hours_68F", "chill_hours_7C", "date_doy", "meta_needs_review", "meta_version", "relative_humidity_max", "relative_humidity_mean", "relative_humidity_min", "wind_2min_vector_dir", "wind_vector_dir", "wind_vector_dir_stand_dev"
        ),
        digits = 0
      ) |>
      DT::formatRound(
  ...
  } else if (timeStep == "Hourly") { # Hourly data formatting
    tablePreview <- tablePreview |>
      DT::formatRound(
        columns = c(
          "date_doy", "meta_needs_review", "meta_version", "relative_humidity", "wind_2min_vector_dir", "wind_vector_dir", "wind_vector_dir_stand_dev"
        ),
        digits = 0
      ) |>
      DT::formatRound(
